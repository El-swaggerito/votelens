        ...
        <div className="p-4 sm:p-8 max-w-[1600px] w-full mx-auto space-y-8">
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={stat.label}
                className="bg-surface-container-lowest p-6 rounded-xl shadow-civilized flex flex-col justify-between group"
              >
                <div className="flex justify-between items-start">
                  <span className="p-2 bg-secondary-container text-primary rounded-lg">
                ...
                <div className="mt-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-on-surface font-display mt-1">
                    {stat.value}
                  </h3>
                </div>
              </div>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 bg-surface-container-lowest rounded-xl p-6 sm:p-8 shadow-civilized overflow-hidden flex flex-col border border-outline-variant/5">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
                ...
                <div className="flex bg-surface-container-low p-1 rounded-full">
                  <button className="px-4 py-1.5 rounded-full bg-primary text-white text-[10px] font-bold uppercase tracking-wider shadow-sm">
                    Bar Chart
                  </button>
                  <button className="px-4 py-1.5 rounded-full text-on-surface-variant text-[10px] font-bold uppercase tracking-wider hover:bg-surface-variant transition-all">
                    Line Trend
                  </button>
                </div>
              </div>

              <div className="flex-1 flex items-end gap-4 sm:gap-12 pt-4 min-h-[300px]">
                {[
            ...
            {/* AI Insights Panel */}
            <div className="lg:col-span-4 bg-[#002110] text-white rounded-xl p-6 sm:p-8 flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-surface-container-low rounded-2xl p-6 sm:p-8 h-[500px] flex flex-col shadow-inner border border-outline-variant/10">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-primary"></span> Party A
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-secondary"></span> Party B
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-tertiary"></span> Party C
                  </div>
                </div>
              </div>
            ...
            <div className="bg-surface-container-lowest rounded-2xl p-6 sm:p-8 shadow-civilized flex flex-col border border-outline-variant/5">
              <h4 className="text-lg font-bold text-on-surface font-display uppercase tracking-tight mb-8">
                Regional Breakdown
              </h4>
              <div className="flex-1 overflow-y-auto space-y-6 pr-2 custom-scrollbar">
                {[
                  ...
                  <div key={region.name} className="p-5 bg-surface rounded-2xl border border-outline-variant/10 hover:border-primary/20 transition-all group">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-[10px] font-bold text-primary bg-primary/5 px-2 py-1 rounded">
                        {region.counted} Counted
                      </span>
                    </div>
                    <div className="w-full h-2.5 bg-surface-container-highest rounded-full flex overflow-hidden shadow-inner">
                    ...
                    <div className="flex justify-between mt-3 text-[10px] font-black text-on-surface-variant uppercase tracking-[0.1em]">
                      <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span> A: {region.a}</span>
                      <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-secondary"></span> B: {region.b}</span>
                      <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-tertiary"></span> C: {region.c}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <section className="bg-surface-container-lowest rounded-2xl shadow-civilized overflow-hidden border border-outline-variant/5">
            <div className="p-6 sm:p-8 border-b border-outline-variant/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div>
                <h4 className="text-lg font-bold text-on-surface font-display uppercase tracking-tight">
              ...
              <table className="w-full text-left">
                <thead className="bg-surface-container-low text-on-surface-variant text-[10px] uppercase font-black tracking-[0.2em]">
                  <tr>
                    ...
                    <th className="px-8 py-5">Current Lead</th>
                    <th className="px-8 py-5">Vote Count</th>
                ...
                <tbody className="divide-y divide-outline-variant/10 text-sm">
                  {[
                    ...
                    <tr key={row.name} className="hover:bg-surface-container-low/30 transition-colors group">
                      <td className="px-8 py-6 font-bold text-on-surface uppercase tracking-tight">{row.name}</td>
                      ...
                      <td className="px-8 py-6 font-bold tabular-nums">{row.count}</td>
                      <td className="px-8 py-6 text-tertiary font-black tabular-nums">{row.margin}</td>
                      <td className="px-8 py-6">
                        <span className={`px-3 py-1.5 ${row.status === "Verified" ? "bg-tertiary-container text-white" : "bg-secondary-container text-on-secondary-fixed-variant"} text-[10px] font-black uppercase rounded-lg shadow-sm`}>
                          {row.status}
                        </span>
                      </td>
                    </tr>
