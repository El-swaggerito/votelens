        ...
        <div className="p-4 sm:p-8 max-w-[1400px] w-full mx-auto space-y-8">
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8 space-y-8">
              {/* Header Info */}
              <div className="bg-surface-container-lowest rounded-xl p-6 sm:p-8 flex flex-col md:flex-row gap-8 items-start md:items-center shadow-civilized">
                ...
                <div className="flex-1 space-y-4">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="bg-tertiary-container/10 px-3 py-1 rounded-md flex items-center space-x-1.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-surface-container-lowest rounded-xl p-6 sm:p-8 space-y-6 shadow-civilized">
                ...
                <div className="bg-surface-container-lowest rounded-xl p-6 sm:p-8 space-y-6 shadow-civilized">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="w-full flex items-center justify-center space-x-2 text-xs font-bold text-primary border border-primary/20 py-2.5 rounded-lg hover:bg-primary/5 transition-colors">
              ...
              {/* Biometric Log */}
              <div className="bg-surface-container-lowest rounded-xl p-6 sm:p-8 shadow-civilized">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 p-4 bg-surface rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-on-surface-variant truncate">
                        Continuous Voter Registration (CVR) - Center 04
                      </p>
                    </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-surface rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-bold truncate">
                        Facial Biometric Update
                      </p>
                      <p className="text-[10px] text-on-surface-variant truncate">
                        Mobile INEC Portal Validation
                      </p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-xs font-bold text-tertiary">SUCCESS</p>
            ...
            <div className="lg:col-span-4 space-y-8">
              {/* PVC Status Card */}
              <div className="bg-primary p-6 sm:p-8 rounded-xl text-white relative overflow-hidden group shadow-lg shadow-primary/20">
                <div className="relative z-10 space-y-6">
                  ...
                  <button className="w-full py-4 bg-white text-primary rounded-full font-black text-xs shadow-lg hover:scale-[1.02] active:scale-95 transition-all uppercase tracking-widest">
                    Download Slip (PDF)
                  </button>
                </div>
              ...
              {/* Voter Stats */}
              <div className="bg-surface-container-high rounded-xl p-6 sm:p-8 space-y-6 shadow-civilized">
              ...
              {/* Quick Actions */}
              <div className="bg-surface-container-lowest p-6 rounded-xl shadow-civilized border-l-4 border-primary">
                ...
                <div className="space-y-1">
                  {[
                    ...
                    <button
                      key={action}
                      className="w-full text-left px-3 py-2.5 text-xs font-medium text-on-surface-variant hover:bg-surface hover:text-primary rounded-lg transition-colors flex items-center justify-between group"
                    >
                      {action}
